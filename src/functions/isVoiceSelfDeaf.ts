...
const $isVoiceSelfDeaf: FunctionData = {
    name: "$isVoiceSelfDeaf",
    description: "whether an user is self deafened in a voice channel.",
    returns: "BOOLEAN",
    brackets: true,
    optional: true,
    fields: [
...
export default $isVoiceSelfDeaf;
